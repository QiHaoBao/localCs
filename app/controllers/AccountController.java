...
//	}
	...
	public static Result getJsonData() {
		...
		JsonNode response = RESTfulCalls.postAPI("http://localhost:9020/workflow/generateWorkflowJson", queryJson);
//		Application.flashMsg(response);
	...
	public static Result getRecommend() {
		...
		String resStr = response.toString();
		return ok(views.recommend.render(resStr));
	}
...
//		String resStr = response.toString();
//		return ok(views.dataRecommend.render(resStr));
//	}
